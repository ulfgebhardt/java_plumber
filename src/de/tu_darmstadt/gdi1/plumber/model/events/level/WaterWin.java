...
/**
 * event which is triggered when water is in sink
 */
public class WaterWin extends LevelEvent_abstract {
	 ...
	 */
	public WaterWin(Level currentLevel) {
		super(currentLevel);
		// TODO Auto-generated constructor stub
	}

	/**
	 * trigger waterwin event
	 */
	@Override
